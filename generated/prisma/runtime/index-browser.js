...
var ne = (e, n, i) =>
	n.has(e) ? Ye('Cannot add the same private member more than once')
	: n instanceof WeakSet ? n.add(e)
	: n.set(e, i);
var ii = {};
Oe(ii, {
	Decimal: () => Je,
...
h.modulo = h.mod = function (e) {
	...
	return (
		(e = new t(e)),
		!i.d || !e.s || (e.d && !e.d[0]) ? new t(NaN)
		: !e.d || (i.d && !i.d[0]) ? p(new t(i), t.precision, t.rounding)
		: ((w = !1),
			t.modulo == 9 ?
	...
	return (
		...
		t == null ?
			n < 3 ?
				...
				(o =
					(i < 4 && u == 99999) || (i > 3 && u == 49999) || u == 5e4 || u == 0))
			:	(o =
...
var k = (function () {
	...
	return function (t, r, s, o, u, c) {
		...
		if (
			(S[a] > (O[a] || 0) && l--,
			s == null ? ((I = s = ee.precision), (o = ee.rounding))
			: u ? (I = s + (t.e - r.e) + 1)
			: (I = s),
			I < 0)
		)
...
function L(e, n, i) {
	...
	return (
		n ?
			...
			(s = s + (e.e < 0 ? 'e' : 'e+') + e.e))
		: r < 0 ? ((s = '0.' + U(-r - 1) + s), i && (t = i - o) > 0 && (s += U(t)))
		: r >= o ?
...
function Ge(e) {
	...
	function r(s) {
		...
		if (((f.constructor = r), Fe(s))) {
			(f.s = s.s),
				w ?
					!s.d || s.e > r.maxE ? ((f.e = NaN), (f.d = null))
					: s.e < r.minE ? ((f.e = 0), (f.d = [0]))
		...
		if (((c = typeof s), c === 'number')) {
			...
			if ((s < 0 ? ((s = -s), (f.s = -1)) : (f.s = 1), s === ~~s && s < 1e7)) {
				...
				w ?
					o > r.maxE ? ((f.e = NaN), (f.d = null))
					: o < r.minE ? ((f.e = 0), (f.d = [0]))
					: ((f.e = o), (f.d = [s]))
				:	((f.e = o), (f.d = [s]));
				return;
			}
