...
var us = ne((Ng, ls) => {
	...
	:	(de('color') || de('colors') || de('color=true') || de('color=always'))
		&& (Ge = 1);
	'FORCE_COLOR' in Q
		&& (Q.FORCE_COLOR === 'true' ? (Ge = 1)
		: Q.FORCE_COLOR === 'false' ? (Ge = 0)
		: (Ge =
	...
	function gi(e, r) {
		...
		if (process.platform === 'win32') {
			...
			return (
				Number(n[0]) >= 10 && Number(n[2]) >= 10586 ?
					Number(n[2]) >= 14931 ?
						3
					:	2
				:	1
...
`,
	...
	function As(e) {
		return (
			e && e.DOTENV_KEY && e.DOTENV_KEY.length > 0 ? e.DOTENV_KEY
		...
		return (
			si(e) ?
				Ut(e) ?
					(
						(r =
							(t = (n = e[De]()).getSelectionKeys) == null ? void 0 : t.call(n))
						!= null
					) ?
						r
					:	[]
				: Array.isArray(e) ? zr(e, Qe)
...
function or(e, r, { target: t = 'stdout', ...n } = {}) {
	return (
		Zt.default[t] ? zt.link(e, r)
		: n.fallback === !1 ? e
		: typeof n.fallback === 'function' ? n.fallback(e, r)
		: `${e} (\u200B${r}\u200B)`
	);
}
...
function Er(e) {
	...
	return (
		r
		|| (e?.config.engineType === 'library' ? 'library'
		: e?.config.engineType === 'binary' ? 'binary'
		: e?.config.engineType === 'client' ? 'client'
		: Bc(e))
	);
}
/**
 ...
 *
 * @param root0
 * @param root0.rootEnvPath
 * @param root0.schemaEnvPath
 * @param t
 */
function it(
...
m.modulo = m.mod = function (e) {
	...
	return (
		(e = new n(e)),
		!t.d || !e.s || (e.d && !e.d[0]) ? new n(NaN)
		: !e.d || (t.d && !t.d[0]) ? y(new n(t), n.precision, n.rounding)
		: ((w = !1),
			n.modulo == 9 ?
	...
	return (
		...
		n == null ?
			r < 3 ?
				...
				(s =
					(t < 4 && a == 99999) || (t > 3 && a == 49999) || a == 5e4 || a == 0))
			:	(s =
...
var F = (function () {
	...
	return function (n, i, o, s, a, l) {
		...
		if (
			(_[p] > (K[p] || 0) && c--,
			o == null ? ((ae = o = $t.precision), (s = $t.rounding))
			: a ? (ae = o + (n.e - i.e) + 1)
			: (ae = o),
			ae < 0)
		)
...
function Ks(e) {
	...
	function i(o) {
		...
		if (((u.constructor = i), $s(o))) {
			(u.s = o.s),
				w ?
					!o.d || o.e > i.maxE ? ((u.e = NaN), (u.d = null))
					: o.e < i.minE ? ((u.e = 0), (u.d = [0]))
		...
		if (((l = typeof o), l === 'number')) {
			...
			if ((o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), o === ~~o && o < 1e7)) {
				...
				w ?
					s > i.maxE ? ((u.e = NaN), (u.d = null))
					: s < i.minE ? ((u.e = 0), (u.d = [0]))
					: ((u.e = s), (u.d = [o]))
				:	((u.e = s), (u.d = [o]));
				return;
			}
 ...
 * @param root0
 * @param root0.message
 * @param root0.originalMethod
 * @param root0.isPanic
 * @param root0.callArguments
 */
 ...
 *
 * @param root0
 * @param root0.functionName
 * @param root0.location
 * @param root0.message
 * @param root0.isPanic
 * @param root0.contextLines
 * @param root0.callArguments
 * @param s
 */
function Pd(
...
function Ea(e) {
	...
	return (
		e instanceof Le ? new G(`Prisma.${e._getName()}`)
		: Dr(e) ? new G(`prisma.${Ye(e.modelName)}.$fields.${e.name}`)
		: Array.isArray(e) ? Kd(e)
		: typeof e === 'object' ? ba(e)
 ...
 * @param root0.args
 * @param root0.errors
 * @param root0.errorFormat
 * @param root0.callsite
 * @param root0.originalMethod
 * @param root0.clientVersion
 * @param root0.globalOmit
 */
function An({
	args: e,
	errors: r,
 ...
 * @param root0.action
 * @param root0.args
 * @param root0.runtimeDataModel
 * @param root0.extensions
 * @param root0.callsite
 * @param root0.clientMethod
 * @param root0.errorFormat
 * @param root0.clientVersion
 * @param root0.previewFeatures
 * @param root0.globalOmit
 */
function Dn({
	modelName: e,
 ...
 *
 * @param root0
 * @param root0.includeOrSelect
 * @param root0.result
 * @param root0.parentModelName
 * @param root0.runtimeDataModel
 * @param root0.visitor
 */
function za({
...
function cl(e, r) {
	return (
		e ?
			...
			: e.datasourceUrl ? { [r[0]]: { url: e.datasourceUrl } }
			: {}
		:	{}
	);
}
 ...
 * @param root0
 * @param root0.version
 * @param root0.binaryTarget
 * @param root0.title
 * @param root0.description
 * @param root0.engineVersion
 ...
 *
 * @param root0
 * @param root0.inlineDatasources
 * @param root0.overrideDatasources
 * @param root0.env
 * @param root0.clientVersion
 */
function jr({
		...
		requestInternal({
			...
			return this.withRetry({
				...
				callback: async ({ logHttpCall: o }) => {
					let s =
						i ? `${i.payload.endpoint}/graphql` : await this.url('graphql');
					o(s);
					let a = await dr(
						s,
						{
...
function xf(e) {
	return (
		e instanceof ArrayBuffer || e instanceof SharedArrayBuffer ? !0
	...
	class r {
		...
		constructor(n) {
			...
			try {
				...
				let d = u.engine || {};
				if (
					(l.errorFormat ? (this._errorFormat = l.errorFormat)
					: process.env.NODE_ENV === 'production' ?
						(this._errorFormat = 'minimal')
					: process.env.NO_COLOR ? (this._errorFormat = 'colorless')
